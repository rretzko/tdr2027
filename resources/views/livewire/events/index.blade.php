        ...
        <div class="space-y-4">
            ...
            <div class="border border-zinc-200 dark:border-zinc-700 rounded-lg p-4 space-y-4">
                <div>
                    ...
                    @if ($editingEventId === null)
                        <flux:text size="sm" class="text-zinc-500">
                            Optionally identify teachers who should manage this event alongside you.
                        </flux:text>
                    @else
                        <flux:text size="sm" class="text-zinc-500">
                            Managed from the event's Versions &rarr; Roles tab.
                        </flux:text>
                    @endif
                </div>
                ...
                @if ($editingEventId === null)
                    ...
                    @endif
                @else
                    @if ($existingEventManagers->isNotEmpty())
                        <div class="flex flex-col gap-2">
                            @foreach ($existingEventManagers as $manager)
                    ...
                    @else
                        <flux:text size="sm" class="text-zinc-500">No Event Managers assigned yet.</flux:text>
                    @endif
                @endif
            </div>
        </div>
